...
const Svg =({color=primaryColor ,className="",strokeWidth="0",stroke="currentColor", size=24, viewBox="0 0 24 24",children,...props})=>

  (<svg className={className} fill={color} width={size}  height={size} viewBox ={viewBox} stroke={stroke} strokeWidth={strokeWidth} xmlns="http://www.w3.org/2000/svg"  {...props}>
...
export const List = ({color,className,stroke ,strokeWidth, size, viewBox}) => {
  return (
    <Svg
    color={color}
    className={className}
...
export const GridMode= ({color,className,stroke ,strokeWidth, size, viewBox}) => {
  return (
    ...
    strokeWidth={strokeWidth}
      ...
      viewBox={viewBox}
    >
    <path xmlns="http://www.w3.org/2000/svg" d="M4 5v13h17V5H4zm10 2v3.5h-3V7h3zM6 7h3v3.5H6V7zm0 9v-3.5h3V16H6zm5 0v-3.5h3V16h-3zm8 0h-3v-3.5h3V16zm-3-5.5V7h3v3.5h-3z"/>    </Svg>
  );
};
export const MultDots= ({color,className,stroke ,strokeWidth, size, viewBox}) => {
  return (
    ...
    strokeWidth={strokeWidth}
      ...
      viewBox={viewBox}
    >
    <path xmlns="http://www.w3.org/2000/svg" d="M19 5v2h-4V5h4M9 5v6H5V5h4m10 8v6h-4v-6h4M9 17v2H5v-2h4M21 3h-8v6h8V3zM11 3H3v10h8V3zm10 8h-8v10h8V11zm-10 4H3v6h8v-6z"/>
      </Svg>
  );
};
